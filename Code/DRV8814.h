...
#define DRV8814_DIRA_FWD	SET_BITS(GPIO(DRV8814_PHS_PORT)->ODR, (0x01) << DRV8814_PHSA_PIN)	// forward
#define DRV8814_DIRA_BKWD	CLR_BITS(GPIO(DRV8814_PHS_PORT)->ODR, (0x01) << DRV8814_PHSA_PIN)	// backward

#define DRV8814_DIRB_FWD	SET_BITS(GPIO(DRV8814_PHS_PORT)->ODR, (0x01) << DRV8814_PHSB_PIN)	// forward
#define DRV8814_DIRB_BKWD	CLR_BITS(GPIO(DRV8814_PHS_PORT)->ODR, (0x01) << DRV8814_PHSB_PIN)	// backward
